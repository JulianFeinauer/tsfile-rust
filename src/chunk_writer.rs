...
use std::io;
use std::io::Write;
use crate::{CompressionType, IoTDBValue, PageWriter, PositionedWrite, Serializable, StatisticsStruct, TSDataType, TSEncoding, utils, write_str};
...
pub struct ChunkMetadata {
    ...
    pub(crate) statistics: StatisticsStruct<i32>,
}
